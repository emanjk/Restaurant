...
public class Menu extends javax.swing.JFrame {
   ...
   private DefaultTableModel modelo = new DefaultTableModel(); // (2). tabla
    ...
    private void initComponents() {
        ...
        panel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 80, 150, 28));
        ...
        panel1.add(jBAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, 140, 46));

        jSeparator1.setBackground(new java.awt.Color(204, 204, 204));
        panel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 292, 10));
